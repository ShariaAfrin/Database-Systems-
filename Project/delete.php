...
if (!$conn) {
	...
	$id=$_POST['pid'];
	$pass=$_POST['pwd'];
	$query1 = "DELETE from feedback where publisher_id=(SELECT publisher_id from publisher_panel where publisher_id='$id'&&password='$pass')";
	mysqli_query($conn,$query1);
    $query2 = "SELECT user_name,email,contact,city,field_of_interest,feedback from feedback where publisher_id=(SELECT publisher_id from publisher_panel where publisher_id='$id'&&password='$pass')";
